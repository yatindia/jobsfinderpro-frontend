...
function MyJobs(){
    ...
    useEffect(() => {
            const city = items.filter( (bs) => bs.position.includes("Frontend"))
            setBank(city)
      },[]);
                    ...
                    <div className="row z-depth-3">
                        <div className="col-sm-3 bg-info rounded-left">
                            <div className="card-block text-center text-white">
                                <img className="mt-3 img-fluid imglogo" src={logo} alt="sample"></img>
                        ...
                        <div className="col-sm-9 bg-white rounded-right">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg">
                                    <button className="btn btn-info mr-4" disabled={true}>Applied</button>
                                </div>
                            </div>
