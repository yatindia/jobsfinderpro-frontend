...
import FindJobs from "./jobList/findJob";
import data from '../components/asserts/data.json'
import Fetcher from "./jobList/fetcher";
...
const handleSubmit=()=>{
    ...
    :""}
{console.log(getter)}
    {active === "job" ?<div className ="m-4">
        <Fetcher></Fetcher>
    </div>:""}

    {active === "list" ?<div className ="m-4">
        <FindJobs keywords={search}></FindJobs>
    </div>:""}
    </>);
}
